...
export default function Privacy() {
	...
	return (
		<PoliciesLayout>
			...
			<div className="space-y-2">
				<p>Authentication data tied to local system accounts.</p>
				<p>
					Technical and operational logs (system events, error messages, security
					events).
				</p>
				<p>Configuration data provided by the {operator} or Users.</p>
				<p>Any other content voluntarily processed within the Instance.</p>
			</div>
