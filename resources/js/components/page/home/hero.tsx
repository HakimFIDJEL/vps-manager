		...
		<section className="relative py-36">
			<div className="relative z-10 mx-auto w-full">
				<div className="md:w-1/2">
					<div>
						<h1 className="max-w-md text-balance text-4xl font-base md:text-6xl">
							VPS Management Simplified
						</h1>
						<p className="text-muted-foreground my-8 max-w-2xl text-balance text-xl font-light">
			...
			<div className="perspective-near mt-24 translate-x-12 md:absolute md:-right-6 md:bottom-16 md:left-1/2 md:top-40 md:mt-0 md:translate-x-0 relative">
